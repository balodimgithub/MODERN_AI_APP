...
export const Gradient = () => {
  return (
    <div className="absolute  top-1/2 left-1 h-[56.625rem] opacity-50 mix-blend-color-dodge pointer-events-none">
      <img
        className="absolute top-1 left-1  md:max-w-[79.5625rem] h-[88.5625rem]  -translate-y-1/2"
        src={gradient}
        alt="Gradient"
      />
    </div>
